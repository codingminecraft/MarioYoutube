...
public class GameCamera extends Component {
    ...
    public void start() {
        ...
        this.undergroundYLevel = this.gameCamera.position.y - this.gameCamera.projectionSize.y - cameraBuffer;
        this.skyYLevel = this.gameCamera.position.y + this.gameCamera.projectionSize.y + cameraBuffer;
    }
